...
class ThreeGrainsDiscountTest {

    @Test
    void shouldApply3GrainsDiscountWhen3OrMoreGrainsAreInReceipt() {
        // Given
        ...
        var discount = new ThreeGrainsDiscount();
    ...
    @Test
    void shouldNotApply3GrainsDiscountWhenLessThan3GrainsAreInReceipt() {
        // Given
        var productDb = new ProductDb();
        var bread = productDb.getProduct("Bread");
        var cereals = productDb.getProduct("Cereals");
